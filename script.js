let first = null;
let second = "https://discord.gg/bHaeD9zXvN";
let third = "KEJRolePlay";


function copyText(text) {
    if (text == "first") {
        alert('Sunucu Adresimiz : XXX')
    }
    if (text == "second") {
...
function openLink(value) {
    ...
    if (value == "second") {
        window.location.href = "https://discord.gg/bHaeD9zXvN";
    }
    if (value == "third") {
    ...
    if (value == "staff") {
      ...
      alert('Server Sahiplerimiz')
    }
    if (value == "rules" || value == "whitelist") {
        alert('KEJ RolePlay Bu Sayfa Bakımda')
    }
}
